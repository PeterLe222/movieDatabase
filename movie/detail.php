...
//
 while ($row=mysqli_fetch_array($query_result)){?>
  ...
  <h2>Title:       </h2>   <p class=\"detailp\">    <?php echo $row['title'];?></p>
  <h2>Publish Date:  </h2> <p class=\"detailp\">   <?php echo $row['publishDate'];?></p>
  <h2>Category:   </h2>    <p class=\"detailp\">  <?php echo $row['category'];?></p>
  <h2>Description:  </h2>  <p class=\"detailp\">   <?php echo $row['movieDesc'];?></p>
  <h2>Artist:       </h2>  <p class=\"detailp\">  <?php while ($name=mysqli_fetch_array($detail_result)) {
